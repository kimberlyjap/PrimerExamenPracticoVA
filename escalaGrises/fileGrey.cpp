...
void mostrarEcualizada(Mat imagen) {
	...
	original = imread("C:/Users/kpi00/Downloads/lenahermosa.jpg");//Accesar a la ubicación de la imagen
...
int main() {
	...
	// Matriz de la imagen
// Leer imagen
	cv::Mat imagen = cv::imread("C:/Users/kpi00/Downloads/lenahermosa.jpg");// Matriz que contiene nuestra imagen sin tomar en cuenta el formato
